...
class App extends Component {
  ...
  resultsCount() {
    if (this.state.createdMineral != null) {
      return `${this.state.createdMineral.length} results`;
    }
  }
              ...
              <Grid item>
                <Paper
                  ...
                  style={{
                    ...
                    /*background:
                      "linear-gradient(45deg, #009faf 30%, #e0f2f1 90%)"*/
                  }}
                >
        ...
        <main className="content">
          ...
          >
            ...
            >
              ...
              <div className="result-count">{this.resultsCount()}</div>
